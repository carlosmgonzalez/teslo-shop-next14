...
export const Pagination = ({ totalPages }: Props) => {
	...
	const pathname = usePathname(); // si el url es: www.tesloshop.com/gender/man?page=1&order='abc' => tesloshop/gender/man
	const searchParams = useSearchParams(); // si el url es: www.tesloshop.com/gender/man?page=1&order='abc' => {page: "1", order: "abc"}
	const currentPage =
